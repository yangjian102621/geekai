...
**GeekAI** 基于 AI 大语言模型 API 实现的 AI 助手全套开源解决方案，自带运营管理后台，开箱即用。集成了 OpenAI, Claude, 通义千问，Kimi，DeepSeek，Gitee AI，[MiniMax](https://www.minimaxi.com) 等多个平台的大语言模型。集成了 MidJourney 和 Stable Diffusion AI 绘画功能。
...
- 支持 OpenAI, Claude, 通义千问，Kimi，DeepSeek, [MiniMax](https://www.minimaxi.com) 等多个大语言模型，**支持 Gitee AI Serverless 大模型 API**。
- 支持 Suno 文生音乐
